...
let body i = Tst.Expr.literal ~loc (Int (Int64.of_int i))

let compile patterns ~scrutinee_ty =
  let rows =
    Nonempty_list.of_list_exn
      (List.mapi patterns ~f:(fun i (pattern, bindings) ->
         { Syl.Match.Case.pattern; body = body (i + 1); bindings }))
  in
  let { Match.Result.tree; redundant; missing } = Syl.Match.compile ~ty:scrutinee_ty rows in
  print_s
    [%message
      (tree : Match.Tree.t)
...
let%expect_test "bool exhaustive" =
  ...
  [%expect
    {|
    ((tree
      (Switch (occurrence ((path ()) (ty Bool)))
       (cases
        (((Literal (Bool true))
          (Leaf
           (action
...
let%expect_test "tuple paths" =
  ...
  [%expect
    {|
    ((tree
      (Switch (occurrence ((path ()) (ty (Tuple ((Type Bool) (Type Bool))))))
       (cases
        (((Tuple 2)
          (Switch (occurrence ((path (0)) (ty Bool)))
           (cases
            (((Literal (Bool true))
              (Leaf
               (action
...
let%expect_test "unit is exhaustive" =
  ...
  [%expect
    {|
    ((tree
      (Switch (occurrence ((path ()) (ty Unit)))
       (cases
        (((Literal Unit)
          (Leaf
           (action
       ...
       (cases
        (((Tuple 2)
          (Switch (occurrence ((path (0)) (ty Bool)))
           (cases
            (((Literal (Bool true))
              (Switch (occurrence ((path (1)) (ty Bool)))
               (cases
                (((Literal (Bool true))
                  (Leaf
                   (action
               ...
               (cases
                (((Literal (Bool true))
                 ...
                 ((Literal (Bool false))
                  (Leaf
                   (action
                    (Literal (value (Int (T 4))) (ty (Type Int))
                     (mode ((staticity Static) (erasure Erased)))
                     (loc ((line 1) (column 0)))))
                   (bindings ())))))
               (default ())))))
...
let%expect_test "tuple (int, bool) - int column needs default" =
  ...
  [%expect
    {|
    ((tree
      (Switch (occurrence ((path ()) (ty (Tuple ((Type Int) (Type Bool))))))
       (cases
        (((Tuple 2)
          (Switch (occurrence ((path (0)) (ty Int)))
           (cases
            (((Literal (Int 0))
              (Switch (occurrence ((path (1)) (ty Bool)))
               (cases
  ...
  [%expect
    ...
    ((tree
      (Switch
       (occurrence
        ((path ())
         (ty (Tuple ((Type (Tuple ((Type Bool) (Type Bool)))) (Type Bool))))))
       (cases
        (((Tuple 2)
          (Switch
           (occurrence ((path (0)) (ty (Tuple ((Type Bool) (Type Bool))))))
           (cases
            (((Tuple 2)
              (Switch (occurrence ((path (0 0)) (ty Bool)))
               (cases
                (((Literal (Bool true))
                  (Switch (occurrence ((path (0 1)) (ty Bool)))
                   (cases
                    (((Literal (Bool true))
                      (Switch (occurrence ((path (1)) (ty Bool)))
                       (cases
...
let%expect_test "tuple (int, int) both wildcards - exhaustive" =
  ...
  [%expect
    {|
    ((tree
      (Switch (occurrence ((path ()) (ty (Tuple ((Type Int) (Type Int))))))
       (cases
        (((Tuple 2)
          (Leaf
           (action
           ...
           (bindings
            ((((Id x) <opaque>)
              ((occurrence ((path (0)) (ty Int)))
               (desc
                ((ty (Type Int)) (mode ((staticity Static) (erasure Unerased)))
                 (static <opaque>)))))
             (((Id y) <opaque>)
              ((occurrence ((path (1)) (ty Int)))
               (desc
                ((ty (Type Int)) (mode ((staticity Static) (erasure Unerased)))
                 (static <opaque>)))))))))))
       (default ())))
...
let%expect_test "triple tuple (bool, bool, bool) one case" =
  ...
  [%expect
    ...
    ((tree
      (Switch
       (occurrence
        ((path ()) (ty (Tuple ((Type Bool) (Type Bool) (Type Bool))))))
       (cases
        (((Tuple 3)
          (Switch (occurrence ((path (0)) (ty Bool)))
           (cases
            (((Literal (Bool true))
              (Switch (occurrence ((path (1)) (ty Bool)))
               (cases
                (((Literal (Bool true))
                  (Switch (occurrence ((path (2)) (ty Bool)))
                   (cases
                    (((Literal (Bool true))
                      (Leaf
                       (action
...
let%expect_test "tuple (bool, int) - column selection prefers bool" =
  ...
  [%expect
    {|
    ((tree
      (Switch (occurrence ((path ()) (ty (Tuple ((Type Bool) (Type Int))))))
       (cases
        (((Tuple 2)
          (Switch (occurrence ((path (0)) (ty Bool)))
           (cases
            (((Literal (Bool true))
              (Switch (occurrence ((path (1)) (ty Int)))
               (cases
                (((Literal (Int 0))
                  (Leaf
                   (action
...
(* --- Redundancy and exhaustiveness coverage --- *)
